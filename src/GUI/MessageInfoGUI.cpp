...
MessageInfoGUI::MessageInfoGUI() : ImGuiPanel("Message Info") {}
...
void MessageInfoGUI::render()
{
    ...
    ImGui::Text("Recieved 1: "); ImGui::SameLine();
    ...
    ImGui::Text("Recieved 2: "); ImGui::SameLine();
    ImGui::TextUnformatted("[FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF]");
    ImGui::Text("Send 1:     "); ImGui::SameLine();
    ImGui::TextUnformatted("[FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF]");
    ImGui::Text("Send 2:     "); ImGui::SameLine();
    ImGui::TextUnformatted("[FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF][FF]");
    ImGui::End();
}